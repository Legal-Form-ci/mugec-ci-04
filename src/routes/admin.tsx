      ...
      <Card className="w-full max-w-md">
        <CardContent className="p-8">
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            ...
            <div><Label htmlFor="admin-pass">Mot de passe</Label><Input id="admin-pass" type="password" value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" required /></div>
